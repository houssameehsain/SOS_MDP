...
class Env(gym.Env):
    ...
    def __init__(self):
        ...
        self.obs_size = 37 # Make sure observation size matches the one in the Gh env
    ...
    def reset(self):
        ...
        self.state = np.asarray(msg["state"])
    ...
    def render(self, mode='human'):
        ...
        img = self.state[self.pad:self.grid_len+self.pad, self.pad:self.grid_len+self.pad]
        img = img.reshape(self.grid_len, self.grid_len)
